...
@WebServlet("/studentcomment")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class CommentServlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
         ...
         String stdcomment = request.getParameter("comment");
         String sqlstr = "INSERT INTO comments (questionNo, stdcomment) VALUES ('"
         + question + "', '"
         + stdcomment + "')";
